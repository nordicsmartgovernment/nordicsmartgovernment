...
<!--BT-15--><xsl:variable name="value" select="//Order/cbc:Note"/><xsl:if test="string($value)"><gl-cor:entriesComment contextRef="now"><xsl:value-of select="$value"/></gl-cor:entriesComment></xsl:if>
...
<!--BT-42--><xsl:variable name="value" select="//Order/cac:BuyerCustomerParty/cac:Party/cac:PartyName/cbc:Name"/><xsl:if test="string($value)"><gl-bus:organizationAddressName contextRef="now"><xsl:value-of select="$value"/></gl-bus:organizationAddressName><gl-bus:organizationAddressPurpose contextRef="now">billing</gl-bus:organizationAddressPurpose></xsl:if>
<!--BT-47--><xsl:variable name="value" select="//Order/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cbc:StreetName"/><xsl:if test="string($value)"><gl-bus:organizationAddressStreet contextRef="now"><xsl:value-of select="$value"/></gl-bus:organizationAddressStreet></xsl:if>
<!--BT-48--><xsl:variable name="value" select="//Order/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cbc:AdditionalStreetName"/><xsl:if test="string($value)"><gl-bus:organizationAddressStreet2 contextRef="now"><xsl:value-of select="$value"/></gl-bus:organizationAddressStreet2></xsl:if>
<!--BT-49--><xsl:variable name="value" select="//Order/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cbc:CityName"/><xsl:if test="string($value)"><gl-bus:organizationAddressCity contextRef="now"><xsl:value-of select="$value"/></gl-bus:organizationAddressCity></xsl:if>
<!--BT-51--><xsl:variable name="value" select="//Order/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cbc:CountrySubentity"/><xsl:if test="string($value)"><gl-bus:organizationAddressStateOrProvince contextRef="now"><xsl:value-of select="$value"/></gl-bus:organizationAddressStateOrProvince></xsl:if>
<!--BT-50--><xsl:variable name="value" select="//Order/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cbc:PostalZone"/><xsl:if test="string($value)"><gl-bus:organizationAddressZipOrPostalCode contextRef="now"><xsl:value-of select="$value"/></gl-bus:organizationAddressZipOrPostalCode></xsl:if>
<!--BT-52--><xsl:variable name="value" select="//Order/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode"/><xsl:if test="string($value)"><gl-bus:organizationAddressCountry contextRef="now"><xsl:value-of select="$value"/></gl-bus:organizationAddressCountry></xsl:if>
</gl-bus:organizationAddress>
<gl-bus:contactInformation>
<!--BT-9--><xsl:variable name="value" select="//Order/cbc:BuyerReference"/>
<!--BT-53--><xsl:variable name="value2" select="//Order/cac:BuyerCustomerParty/cac:Party/cac:Contact/cbc:Name"/>
...
<gl-bus:contactPhone>
<!--BT-54-->
<xsl:variable name="value" select="//Order/cac:BuyerCustomerParty/cac:Party/cac:Contact/cbc:Telephone"/>
...
<gl-bus:contactEMail>
<!--BT-55--><xsl:variable name="value" select="//Order/cac:BuyerCustomerParty/cac:Party/cac:Contact/cbc:ElectronicMail"/><xsl:if test="string($value)"><gl-bus:contactEmailAddress contextRef="now"><xsl:value-of select="$value"/></gl-bus:contactEmailAddress></xsl:if>
</gl-bus:contactEMail>
</gl-bus:contactInformation>
...
<!--Payee party details -->
<!--BT-57--><xsl:variable name="value" select="//Order/cac:PayeeParty/cac:PartyIdentification/cbc:ID"/><xsl:if test="string($value)">
<gl-cor:identifierReference>
...
<!--BT-59--><xsl:variable name="value" select="//Order/cac:TaxRepresentativeParty/cac:PartyName/cbc:Name"/><xsl:if test="string($value)">
<gl-cor:identifierReference>
...
<!--BT-67--><xsl:variable name="value" select="//Order/cac:Delivery/cac:DeliveryParty/cac:PartyName/cbc:Name"/><xsl:if test="string($value)">
<gl-cor:identifierReference>
<gl-cor:identifierDescription contextRef="now"><xsl:value-of select="$value"/></gl-cor:identifierDescription>
...
<xsl:variable name="value2" select="//Order/cbc:AccountingCostCode/text()"/>
<!-- For NSG 3 reference implementation the buyer's country code serves as a identifier for the standardized chart of accounts to be used (which countrie's CoA) (mainAccountTypeDescription)-->
<xsl:variable name="cc" select="//Order/cac:BuyerCustomerParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode"/>
<gl-cor:account>
<!--BT-124--><!--BT-17-->
...
<xsl:variable name="value" select="//Order/cac:ReceiptDocumentReference/cbc:ID"/><xsl:if test="string($value)">
<gl-taf:originatingDocumentStructure>
<gl-taf:originatingDocumentType contextRef="now">receive-advice</gl-taf:originatingDocumentType>
<!--BT-13--><gl-taf:originatingDocumentNumber contextRef="now"><xsl:value-of select="$value"/></gl-taf:originatingDocumentNumber>
</gl-taf:originatingDocumentStructure>
</xsl:if>

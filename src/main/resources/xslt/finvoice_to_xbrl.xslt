...
<!-- string for default namespace uri and schema location -->
  ...
  <xsl:variable name="schemaLoc" select="'http://www.xbrl.org/int/gl/plt/2015-03-25 ../../../taxonomies/XBRL-GL-REC-2017-01-01-fi/gl/plt/case-c-b-m-u-t-s-r/gl-plt-fi-all-2017-01-01.xsd'"/>
 ...
 <xsl:template match='/'>
<xbrli:xbrl xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.xbrl.org/int/gl/plt/2015-03-25 ../../../taxonomies/XBRL-GL-REC-2017-01-01-fi/gl/plt/case-c-b-m-u-t-s-r/gl-plt-fi-all-2017-01-01.xsd" xmlns:gl-plt="http://www.xbrl.org/int/gl/plt/2015-03-25" xmlns:xbrll="http://www.xbrl.org/2003/linkbase" xmlns:gl-cor="http://www.xbrl.org/int/gl/cor/2015-03-25" xmlns:iso639="http://www.xbrl.org/2005/iso639" xmlns:gl-taf="http://www.xbrl.org/int/gl/taf/2015-03-25" xmlns:gl-rapko="http://www.xbrl.org/int/gl/rapko/2015-07-01" xmlns:gl-muc="http://www.xbrl.org/int/gl/muc/2015-03-25" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:gl-bus="http://www.xbrl.org/int/gl/bus/2015-03-25" xmlns:xlink="http://www.w3.org/1999/xlink">
...
<!--BT-23--><xsl:variable name="value" select="//InvoicingPeriodStartDate"/><xsl:if test="string($value)"><gl-cor:periodCoveredStart contextRef="now"><xsl:value-of select="$value"/></gl-cor:periodCoveredStart></xsl:if>
<!--BT-24--><xsl:variable name="value" select="//InvoicingPeriodEndDate"/><xsl:if test="string($value)"><gl-cor:periodCoveredEnd contextRef="now"><xsl:value-of select="$value"/></gl-cor:periodCoveredEnd></xsl:if>
...
<!--Entry Detail tuples-->
<gl-cor:entryDetail>
<!--TODO HUOM! tehty tässä etumerkin vaihdos rahamäärille, koska menevät liikevaihtoon-->
<!--BT-122--><xsl:variable name="value" select="//InvoiceTotalVatIncludedAmount"/><xsl:if test="string($value)"><gl-cor:amount contextRef="now" unitRef="{$value/@AmountCurrencyIdentifier}" decimals="2"><xsl:value-of select="replace($value,',','.')"/></gl-cor:amount><gl-muc:amountCurrency contextRef="now"><xsl:value-of select="$value/@AmountCurrencyIdentifier"/></gl-muc:amountCurrency></xsl:if>
...
<gl-cor:documentNumber contextRef="now"><xsl:value-of select="$value"/></gl-cor:documentNumber></xsl:if>
...
<!--TODO myös myöhemmin.. vaihdettu tässä myyntilasku case "sj"-->
<gl-cor:sourceJournalID contextRef="now">sj</gl-cor:sourceJournalID>
<!--BT-119--><xsl:variable name="value" select="./RowFreeText"/><xsl:if test="string($value)"><gl-cor:entryComment contextRef="now"><xsl:value-of select="$value"/></gl-cor:entryComment></xsl:if>
<!--BT-118--><xsl:variable name="value" select="./RowPositionIdentifier"/><xsl:if test="string($value)"><gl-cor:entryNumberCounter contextRef="now" unitRef="NotUsed" decimals="0"><xsl:value-of select="$value"/></gl-cor:entryNumberCounter></xsl:if>

<!--Entry Detail tuples-->
<gl-cor:entryDetail>
<!--Account tuple-->
<gl-cor:account>
<!--BT-124--><xsl:variable name="value" select="./RowAccountDimensionText"/><xsl:if test="string($value)"><gl-cor:accountMainID contextRef="now"><xsl:value-of select="$value"/></gl-cor:accountMainID></xsl:if>
<!--BT-17--><xsl:variable name="value" select="//AccountDimensionText"/><xsl:if test="string($value)"><gl-cor:accountMainID contextRef="now"><xsl:value-of select="$value"/></gl-cor:accountMainID><gl-cor:accountType>account</gl-cor:accountType></xsl:if>
</gl-cor:account>
<!--TODO HUOM! tehty tässä etumerkin vaihdos rahamäärille, koska menevät liikevaihtoon-->

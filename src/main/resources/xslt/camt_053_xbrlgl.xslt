...
<!-- string for default namespace uri and schema location -->
 <!-- <xsl:variable name="ns" select="'http://www.w3.org/2001/XMLSchema-instance'"/>-->
  <xsl:variable name="ns" select="'urn:iso:std:iso:20022:tech:xsd:camt.053.001.02'"/>
  
  <xsl:variable name="schemaLoc" select="'urn:iso:std:iso:20022:tech:xsd:camt.053.001.02 camt.053.001.02.xsd'"/>
 ...
 <xsl:template match='/'>
<xbrli:xbrl xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.xbrl.org/int/gl/plt/2015-03-25 ../../../taxonomies/XBRL-GL-REC-2017-01-01-fi/gl/plt/case-c-b-m-u-t-s-r/gl-plt-fi-all-2017-01-01.xsd" xmlns:gl-plt="http://www.xbrl.org/int/gl/plt/2015-03-25" xmlns:xbrll="http://www.xbrl.org/2003/linkbase" xmlns:gl-cor="http://www.xbrl.org/int/gl/cor/2015-03-25" xmlns:gl-rapko="http://www.xbrl.org/int/gl/rapko/2015-07-01" xmlns:iso639="http://www.xbrl.org/2005/iso639" xmlns:gl-taf="http://www.xbrl.org/int/gl/taf/2015-03-25" xmlns:gl-muc="http://www.xbrl.org/int/gl/muc/2015-03-25" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:gl-bus="http://www.xbrl.org/int/gl/bus/2015-03-25" xmlns:xlink="http://www.w3.org/1999/xlink">
...
<!-- ISO Index:  5.1.0  --><xsl:variable name="value" select="//BkToCstmrStmt[1]/Stmt/FrToDt/FrDtTm"/><xsl:if test="string($value)"><gl-cor:periodCoveredStart contextRef="now"><xsl:value-of select="$value"/></gl-cor:periodCoveredStart></xsl:if>
<!-- ISO Index:  5.1.1  --><xsl:variable name="value" select="//BkToCstmrStmt[1]/Stmt/FrToDt/ToDtTm"/><xsl:if test="string($value)"><gl-cor:periodCoveredEnd contextRef="now"><xsl:value-of select="$value"/></gl-cor:periodCoveredEnd></xsl:if>
...
<xsl:if test="string($value) and string($value2) and string($ccy)">
...
<!-- ISO Index:  1.2.58  --><xsl:variable name="value" select="//BkToCstmrStmt[1]/Stmt/Acct/Svcr/FinInstnId/BIC"/><xsl:if test="string($value)">
...
<!-- ISO Index:  2.93  -->
<xsl:variable name="value1" select="../BkTxCd/Domn/Cd"/>
<!-- ISO Index:  2.95  -->
<xsl:variable name="value2" select="../BkTxCd/Domn/Fmly/Cd"/>
<!-- ISO Index:  2.96  -->
<xsl:variable name="value3" select="../BkTxCd/Domn/Fmly/SubFmlyCd"/>
<!-- ISO Index:  2.225  -->
<xsl:variable name="value4" select="../Purp/Cd"/>

<xsl:if test="concat(string($value1),string($value2),string($value3))"><gl-cor:entryComment contextRef="now"><xsl:value-of select="concat('vientiselite: ',string($value1),string($value2),string($value3), ' maksun syykoodi: ',string($value4))"/></gl-cor:entryComment></xsl:if>


<!-- ISO Index:  2.45  -->
<!--Not applicable because of POC Header and Header VAT type rows
<xsl:variable name="value" select="//BkToCstmrStmt[1]/Stmt/Acct/TxsSummry/TtlNtries/NbOfNtries"/><xsl:if test="string($value)"><gl-bus:numberOfEntries contextRef="now"><xsl:value-of select="$value"/></gl-bus:numberOfEntries></xsl:if>
-->
<!--Bank statement D/C is the opposite to accounting D/C)-->
<!-- ISO Index:  2.54  --><xsl:variable name="value" select="//TxsSummry/TtlCdtNtries/Sum"/><xsl:if test="string($value)"><gl-bus:totalDebit contextRef="now" unitRef="EUR" decimals="2"><xsl:value-of select="$value"/></gl-bus:totalDebit></xsl:if>
<!-- ISO Index:  2.51  --><xsl:variable name="value" select="//TxsSummry/TtlDbtNtries/Sum"/><xsl:if test="string($value)"><gl-bus:totalCredit contextRef="now" unitRef="EUR" decimals="2"><xsl:value-of select="$value"/></gl-bus:totalCredit></xsl:if>
...
<!--Servicer-Financial Institution-->
<xsl:variable name="value" select="//BkToCstmrStmt[1]/Stmt/Acct/Svc/FinInstnIdr/BIC"/><xsl:if test="string($value)">
<gl-cor:identifierReference>
<gl-cor:identifierExternalReference>
...
<xsl:variable name="value" select="./RltdAgts/DbtrAgt/FinInstnId/BIC"/><xsl:if test="string($value)">
...
<gl-cor:identifierExternalReference>
<!-- ISO Index:  1.2.58  --><xsl:variable name="value" select="./RltdAgts/DbtrAgt/FinInstnId/BIC"/><xsl:if test="string($value)"><gl-cor:identifierAuthorityCode contextRef="now"><xsl:value-of select="$value"/></gl-cor:identifierAuthorityCode><gl-cor:identifierAuthority
...
<xsl:variable name="value" select="./RltdAgts/CdtrAgt/FinInstnId/BIC"/><xsl:if test="string($value)">
...
<gl-cor:identifierExternalReference>
<!-- ISO Index:  6.1.1  --><xsl:variable name="value" select="./RltdAgts/CdtrAgt/FinInstnId/BIC"/><xsl:if test="string($value)"><gl-cor:identifierAuthorityCode contextRef="now"><xsl:value-of select="$value"/></gl-cor:identifierAuthorityCode><gl-cor:identifierAuthority
 contextRef="now">BIC</gl-cor:identifierAuthority></xsl:if>
</gl-cor:identifierExternalReference>
<!--Identifier Organization Type, organization-->
<gl-cor:identifierOrganizationType contextRef="now">organization</gl-cor:identifierOrganizationType>
...
<xsl:variable name="value" select="./RltdPties/Dbtr/Nm"/><xsl:if test="string($value)">
<!--Debtor-->
<gl-cor:identifierReference>
<!--Identifier Organization Type, organization-->
<gl-cor:identifierOrganizationType contextRef="now">organization</gl-cor:identifierOrganizationType>
...
<xsl:variable name="value" select="./RltdPties/Dbtr/PstlAdr/Dept"/>
<!--Debtor Address Details-->
<gl-bus:identifierAddress>
<!-- ISO Index:  9.1.3  --><xsl:variable name="value" select="./RltdPties/Dbtr/PstlAdr/Dept"/><xsl:if test="string($value)"><gl-bus:identifierAddressDescription contextRef="now"><xsl:value-of select="$value"/></gl-bus:identifierAddressDescription></xsl:if>
<!-- ISO Index:  9.1.5  --><xsl:variable name="value" select="./RltdPties/Dbtr/PstlAdr/StrtNm"/><xsl:if test="string($value)"><gl-bus:identifierStreet contextRef="now"><xsl:value-of select="$value"/></gl-bus:identifierStreet></xsl:if>
<!-- ISO Index:  9.1.6  --><xsl:variable name="value" select="./RltdPties/Dbtr/PstlAdr/BldgNb"/><xsl:if test="string($value)"><gl-bus:identifierAddressStreet2 contextRef="now"><xsl:value-of select="$value"/></gl-bus:identifierAddressStreet2></xsl:if>
<!-- ISO Index:  9.1.8  --><xsl:variable name="value" select="./RltdPties/Dbtr/PstlAdr/TwnNm"/><xsl:if test="string($value)"><gl-bus:identifierStateOrProvince contextRef="now"><xsl:value-of select="$value"/></gl-bus:identifierStateOrProvince></xsl:if>
<!-- ISO Index:  9.1.9  --><xsl:variable name="value" select="./RltdPties/Dbtr/PstlAdr/CtrySubDvsn"/><xsl:if test="string($value)"><gl-bus:identifierCountry contextRef="now"><xsl:value-of select="$value"/></gl-bus:identifierCountry></xsl:if>
<!-- ISO Index:  9.1.7  --><xsl:variable name="value" select="./RltdPties/Dbtr/PstlAdr/PstCd"/><xsl:if test="string($value)"><gl-bus:identifierZipOrPostalCode contextRef="now"><xsl:value-of select="$value"/></gl-bus:identifierZipOrPostalCode></xsl:if>
...
<xsl:variable name="value" select="./RltdPties/UltmtDbtr/Nm"/><xsl:if test="string($value)">
<!--Ultimate Debtor-->
<gl-cor:identifierReference>
...
<xsl:variable name="value" select="./RltdPties/UltmtDbtr/PstlAdr/Dept"/><xsl:if test="string($value)">

<!--Ultimate Debtor Address Details-->
<gl-bus:identifierAddress>
<!-- ISO Index:  9.1.3  --><xsl:variable name="value" select="./RltdPties/UltmtDbtr/PstlAdr/Dept"/><xsl:if test="string($value)"><gl-bus:identifierAddressDescription contextRef="now"><xsl:value-of select="$value"/></gl-bus:identifierAddressDescription></xsl:if>
<!-- ISO Index:  9.1.5  --><xsl:variable name="value" select="./RltdPties/UltmtDbtr/PstlAdr/StrtNm"/><xsl:if test="string($value)"><gl-bus:identifierStreet contextRef="now"><xsl:value-of select="$value"/></gl-bus:identifierStreet></xsl:if>
<!-- ISO Index:  9.1.6  --><xsl:variable name="value" select="./RltdPties/UltmtDbtr/PstlAdr/BldgNb"/><xsl:if test="string($value)"><gl-bus:identifierAddressStreet2 contextRef="now"><xsl:value-of select="$value"/></gl-bus:identifierAddressStreet2></xsl:if>
<!-- ISO Index:  9.1.8  --><xsl:variable name="value" select="./RltdPties/UltmtDbtr/PstlAdr/TwnNm"/><xsl:if test="string($value)"><gl-bus:identifierStateOrProvince contextRef="now"><xsl:value-of select="$value"/></gl-bus:identifierStateOrProvince></xsl:if>
<!-- ISO Index:  9.1.9  --><xsl:variable name="value" select="./RltdPties/UltmtDbtr/PstlAdr/CtrySubDvsn"/><xsl:if test="string($value)"><gl-bus:identifierCountry contextRef="now"><xsl:value-of select="$value"/></gl-bus:identifierCountry></xsl:if>
<!-- ISO Index:  9.1.7  --><xsl:variable name="value" select="./RltdPties/UltmtDbtr/PstlAdr/PstCd"/><xsl:if test="string($value)"><gl-bus:identifierZipOrPostalCode contextRef="now"><xsl:value-of select="$value"/></gl-bus:identifierZipOrPostalCode></xsl:if>
</gl-bus:identifierAddress>
</xsl:if>
</gl-cor:identifierReference>
</xsl:if>
...
<!-- ISO Index:  9.1.3  --><xsl:variable name="value" select="./RltdPties/UlmtCdtr/PstlAdr/Dept"/><xsl:if test="string($value)">
<!--Ultimate Creditor-->
<gl-cor:identifierReference>
<!--Identifier Organization Type, organization-->
<gl-cor:identifierOrganizationType contextRef="now">organization</gl-cor:identifierOrganizationType>
...
<gl-bus:identifierAddress>
<!-- ISO Index:  9.1.3  --><xsl:variable name="value" select="./RltdPties/UlmtCdtr/PstlAdr/Dept"/><xsl:if test="string($value)"><gl-bus:identifierAddressDescription contextRef="now"><xsl:value-of select="$value"/></gl-bus:identifierAddressDescription></xsl:if>
<!-- ISO Index:  9.1.5  --><xsl:variable name="value" select="./RltdPties/UlmtCdtr/PstlAdr/StrtNm"/><xsl:if test="string($value)"><gl-bus:identifierStreet contextRef="now"><xsl:value-of select="$value"/></gl-bus:identifierStreet></xsl:if>
<!-- ISO Index:  9.1.6  --><xsl:variable name="value" select="./RltdPties/UlmtCdtr/PstlAdr/BldgNb"/><xsl:if test="string($value)"><gl-bus:identifierAddressStreet2 contextRef="now"><xsl:value-of select="$value"/></gl-bus:identifierAddressStreet2></xsl:if>
<!-- ISO Index:  9.1.8  --><xsl:variable name="value" select="./RltdPties/UlmtCdtr/PstlAdr/TwnNm"/><xsl:if test="string($value)"><gl-bus:identifierStateOrProvince contextRef="now"><xsl:value-of select="$value"/></gl-bus:identifierStateOrProvince></xsl:if>
<!-- ISO Index:  9.1.9  --><xsl:variable name="value" select="./RltdPties/UlmtCdtr/PstlAdr/CtrySubDvsn"/><xsl:if test="string($value)"><gl-bus:identifierCountry contextRef="now"><xsl:value-of select="$value"/></gl-bus:identifierCountry></xsl:if>
<!-- ISO Index:  9.1.7  --><xsl:variable name="value" select="./RltdPties/UlmtCdtr/PstlAdr/PstCd"/><xsl:if test="string($value)"><gl-bus:identifierZipOrPostalCode contextRef="now"><xsl:value-of select="$value"/></gl-bus:identifierZipOrPostalCode></xsl:if>
</gl-bus:identifierAddress>
</gl-cor:identifierReference>
<!--end of Ultimate Creditor-->
</xsl:if>

<!-- ISO Index:  9.1.3  --><xsl:variable name="value" select="./RltdPties/Cdtr/Nm"/><xsl:if test="string($value)">
<!--Creditor-->
<gl-cor:identifierReference>
<!--Identifier Organization Type, organization-->
<gl-cor:identifierOrganizationType contextRef="now">organization</gl-cor:identifierOrganizationType>
<xsl:variable name="value" select="./RltdPties/Cdtr/Nm"/><xsl:if test="string($value)">
...
<gl-bus:identifierAddress>
<!-- ISO Index:  9.1.3  --><xsl:variable name="value" select="./RltdPties/Cdtr/PstlAdr/Dept"/><xsl:if test="string($value)"><gl-bus:identifierAddressDescription contextRef="now"><xsl:value-of select="$value"/></gl-bus:identifierAddressDescription></xsl:if>
<!-- ISO Index:  9.1.5  --><xsl:variable name="value" select="./RltdPties/Cdtr/PstlAdr/StrtNm"/><xsl:if test="string($value)"><gl-bus:identifierStreet contextRef="now"><xsl:value-of select="$value"/></gl-bus:identifierStreet></xsl:if>
<!-- ISO Index:  9.1.6  --><xsl:variable name="value" select="./RltdPties/Cdtr/PstlAdr/BldgNb"/><xsl:if test="string($value)"><gl-bus:identifierAddressStreet2 contextRef="now"><xsl:value-of select="$value"/></gl-bus:identifierAddressStreet2></xsl:if>
<!-- ISO Index:  9.1.8  --><xsl:variable name="value" select="./RltdPties/Cdtr/PstlAdr/TwnNm"/><xsl:if test="string($value)"><gl-bus:identifierStateOrProvince contextRef="now"><xsl:value-of select="$value"/></gl-bus:identifierStateOrProvince></xsl:if>
<!-- ISO Index:  9.1.9  --><xsl:variable name="value" select="./RltdPties/Cdtr/PstlAdr/CtrySubDvsn"/><xsl:if test="string($value)"><gl-bus:identifierCountry contextRef="now"><xsl:value-of select="$value"/></gl-bus:identifierCountry></xsl:if>
<!-- ISO Index:  9.1.7  --><xsl:variable name="value" select="./RltdPties/Cdtr/PstlAdr/PstCd"/><xsl:if test="string($value)"><gl-bus:identifierZipOrPostalCode contextRef="now"><xsl:value-of select="$value"/></gl-bus:identifierZipOrPostalCode></xsl:if>
</gl-bus:identifierAddress>
</gl-cor:identifierReference>
<!--end of Creditor-->
</xsl:if>

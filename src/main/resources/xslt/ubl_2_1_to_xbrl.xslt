...
<!-- string for default namespace uri and schema location -->
 ...
 <xsl:template match='/'>
<xbrli:xbrl xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.xbrl.org/int/gl/plt/2015-03-25 ../../XBRL-GL-REC-2015-07-01-fi_draft/gl/plt/case-c-b-m-u-t-s-r/gl-plt-fi-all-2017-01-01.xsd" xmlns:gl-plt="http://www.xbrl.org/int/gl/plt/2015-03-25" xmlns:xbrll="http://www.xbrl.org/2003/linkbase" xmlns:gl-cor="http://www.xbrl.org/int/gl/cor/2015-03-25" xmlns:iso639="http://www.xbrl.org/2005/iso639" xmlns:gl-taf="http://www.xbrl.org/int/gl/taf/2015-03-25" xmlns:gl-rapko="http://www.xbrl.org/int/gl/rapko/2015-07-01" xmlns:gl-muc="http://www.xbrl.org/int/gl/muc/2015-03-25" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:gl-srcd="http://www.xbrl.org/int/gl/srcd/2015-03-25" xmlns:gl-bus="http://www.xbrl.org/int/gl/bus/2015-03-25" xmlns:gl-cor-fi="http://www.xbrl.org/int/gl/cor/fi/2017-01-01" xmlns:xlink="http://www.w3.org/1999/xlink">
  <xbrll:schemaRef xlink:type="simple" xlink:href="../../XBRL-GL-REC-2015-07-01-fi_draft/gl/plt/case-c-b-m-u-t-s-r/gl-plt-fi-all-2017-01-01.xsd" xlink:arcrole="http://www.w3.org/1999/xlink/properties/linkbase"/>
...
<!--BT-23--><xsl:variable name="value" select="//Invoice/cac:InvoicePeriod/cbc:StartDate"/><xsl:if test="string($value)"><gl-cor:periodCoveredStart contextRef="now"><xsl:value-of select="$value"/></gl-cor:periodCoveredStart></xsl:if>
<!--BT-24--><xsl:variable name="value" select="//Invoice/cac:InvoicePeriod/cbc:EndDate"/><xsl:if test="string($value)"><gl-cor:periodCoveredEnd contextRef="now"><xsl:value-of select="$value"/></gl-cor:periodCoveredEnd></xsl:if>
...
<!--BT-42--><xsl:variable name="value" select="//Invoice/cac:AccountingCustomerParty/cac:Party/cac:PartyName/cbc:Name"/><xsl:if test="string($value)"><gl-bus:organizationAddressName contextRef="now"><xsl:value-of select="$value"/></gl-bus:organizationAddressName><gl-bus:organizationAddressPurpose contextRef="now">billing</gl-bus:organizationAddressPurpose></xsl:if>
<!--BT-47--><xsl:variable name="value" select="//Invoice/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:StreetName"/><xsl:if test="string($value)"><gl-bus:organizationAddressStreet contextRef="now"><xsl:value-of select="$value"/></gl-bus:organizationAddressStreet></xsl:if>
<!--BT-48--><xsl:variable name="value" select="//Invoice/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:AdditionalStreetName"/><xsl:if test="string($value)"><gl-bus:organizationAddressStreet2 contextRef="now"><xsl:value-of select="$value"/></gl-bus:organizationAddressStreet2></xsl:if>
<!--BT-49--><xsl:variable name="value" select="//Invoice/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:CityName"/><xsl:if test="string($value)"><gl-bus:organizationAddressCity contextRef="now"><xsl:value-of select="$value"/></gl-bus:organizationAddressCity></xsl:if>
<!--BT-51--><xsl:variable name="value" select="//Invoice/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:CountrySubentity"/><xsl:if test="string($value)"><gl-bus:organizationAddressStateOrProvince contextRef="now"><xsl:value-of select="$value"/></gl-bus:organizationAddressStateOrProvince></xsl:if>
<!--BT-50--><xsl:variable name="value" select="//Invoice/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:PostalZone"/><xsl:if test="string($value)"><gl-bus:organizationAddressZipOrPostalCode contextRef="now"><xsl:value-of select="$value"/></gl-bus:organizationAddressZipOrPostalCode></xsl:if>
<!--BT-52--><xsl:variable name="value" select="//Invoice/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode"/><xsl:if test="string($value)"><gl-bus:organizationAddressCountry contextRef="now"><xsl:value-of select="$value"/></gl-bus:organizationAddressCountry></xsl:if>
</gl-bus:organizationAddress>
<gl-bus:contactInformation>
<!--BT-9--><xsl:variable name="value" select="//Invoice/cbc:BuyerReference"/>
<!--BT-53--><xsl:variable name="value2" select="//Invoice/cac:AccountingCustomerParty/cac:Party/cac:Contact/cbc:Name"/>
...
<gl-bus:contactPhone>
<!--BT-54-->
<xsl:variable name="value" select="//Invoice/cac:AccountingCustomerParty/cac:Party/cac:Contact/cbc:Telephone"/>
...
<gl-bus:contactEMail>
<!--BT-55--><xsl:variable name="value" select="//Invoice/cac:AccountingCustomerParty/cac:Party/cac:Contact/cbc:ElectronicMail"/><xsl:if test="string($value)"><gl-bus:contactEmailAddress contextRef="now"><xsl:value-of select="$value"/></gl-bus:contactEmailAddress></xsl:if>
</gl-bus:contactEMail>
</gl-bus:contactInformation>
...
<!--Account tuple-->
<gl-cor:account>
<!--Todo näitä mäppäyksiä on kaksi, kumpaa käytetään?-->
<!--BT-124-->
<!--<xsl:variable name="value" select="./cbc:AccountingCost"/><xsl:if test="string($value)"><gl-cor:accountMainID contextRef="now"><xsl:value-of select="$value"/></gl-cor:accountMainID></xsl:if>-->
<!--BT-17--><xsl:variable name="value" select="//Invoice/cbc:AccountingCost"/><xsl:if test="string($value)"><gl-cor:accountMainID contextRef="now"><xsl:value-of select="$value"/></gl-cor:accountMainID></xsl:if>
</gl-cor:account>
<!--BT-122--><xsl:variable name="value" select="./cbc:LineExtensionAmount"/><xsl:if test="string($value)"><gl-cor:amount contextRef="now" unitRef="{$value/@currencyID}" decimals="2"><xsl:value-of select="$value"/></gl-cor:amount></xsl:if>
...
<gl-cor:identifierExternalReference>
 <!--BT-28-->
<xsl:variable name="value" select="//Invoice/cac:AccountingSuppierParty/cac:Party/cac:PartyLegalEntity/cbc:CompanyID"/>
<xsl:if test="string($value)">
...
<gl-cor:identifierExternalReference>
 <!--BT-30--><xsl:variable name="value" select="//Invoice/cac:AccountingSuppierParty/cac:Party/cac:PartyTaxScheme/cbc:CompanyID"/><xsl:if test="string($value)"><gl-cor:identifierAuthorityCode contextRef="now"><xsl:value-of select="$value"/></gl-cor:identifierAuthorityCode><gl-cor:identifierAuthority contextRef="now">alvtunnus</gl-cor:identifierAuthority></xsl:if>
...
<xsl:variable name="value" select="//Invoice/cac:AccountingSuppierParty/cac:Party/cac:PartyTaxScheme/cbc:CompanyID/Invoice/cac:AccountingSuppierParty/cac:Party/cac:PartyTaxScheme/cac:TaxScheme/cbc:ID"/><xsl:if test="string($value)">
<gl-cor:identifierExternalReference>
...
<!--BT-33--><xsl:variable name="value" select="//Invoice/cac:AccountingSupplierParty/Party/PostalAddress/cbc:StreetName"/><xsl:if test="string($value)"><gl-bus:identifierStreet contextRef="now"><xsl:value-of select="$value"/></gl-bus:identifierStreet></xsl:if>
<!--BT-34--><xsl:variable name="value" select="//Invoice/cac:AccountingSupplierParty/Party/PostalAddress/cbc:AdditionalStreetName"/><xsl:if test="string($value)"><gl-bus:identifierAddressStreet2 contextRef="now"><xsl:value-of select="$value"/></gl-bus:identifierAddressStreet2></xsl:if>
<!--BT-35--><xsl:variable name="value" select="//Invoice/cac:AccountingSuppierParty/cac:Party/cac:PostalAddress/cbc:CityName"/><xsl:if test="string($value)"><gl-bus:identifierCity contextRef="now"><xsl:value-of select="$value"/></gl-bus:identifierCity></xsl:if>
<!--BT-38--><xsl:variable name="value" select="//Invoice/cac:AccountingSuppierParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode"/><xsl:if test="string($value)"><gl-bus:identifierCountry contextRef="now"><xsl:value-of select="$value"/></gl-bus:identifierCountry></xsl:if>
<!--BT-36--><xsl:variable name="value" select="//Invoice/cac:AccountingSuppierParty/cac:Party/cac:PostalAddress/cbc:PostalZone"/><xsl:if test="string($value)"><gl-bus:identifierZipOrPostalCode contextRef="now"><xsl:value-of select="$value"/></gl-bus:identifierZipOrPostalCode></xsl:if>
</gl-bus:identifierAddress>
<!--Seller contact information-->
<gl-cor:identifierContactInformationStructure>
<!--BT-39--><xsl:variable name="value" select="//Invoice/cac:AccountingSupplierParty/Party/Contact/cbc:Name"/><xsl:if test="string($value)"><gl-cor:identifierContactAttentionLine contextRef="now"><xsl:value-of select="$value"/></gl-cor:identifierContactAttentionLine></xsl:if>
<gl-cor:identifierContactPhone>
<!--BT-40--><xsl:variable name="value" select="//Invoice/cac:AccountingSupplierParty/Party/Contact/cbc:Telephone"/><xsl:if test="string($value)"><gl-cor:identifierContactPhoneNumber contextRef="now"><xsl:value-of select="$value"/></gl-cor:identifierContactPhoneNumber></xsl:if>
</gl-cor:identifierContactPhone>
<gl-cor:identifierContactEmail>
<!--BT-41--><xsl:variable name="value" select="//Invoice/cac:AccountingSupplierParty/Party/Contact/cbc:ElectronicMail"/><xsl:if test="string($value)"><gl-cor:identifierContactEmailAddress contextRef="now"><xsl:value-of select="$value"/></gl-cor:identifierContactEmailAddress></xsl:if>
</gl-cor:identifierContactEmail>
</gl-cor:identifierContactInformationStructure>
</gl-cor:identifierReference>
...
<!--BT-143--><xsl:variable name="value" select="./cac:Item/ClassifiedTaxCategory/cbc:Percent"/><xsl:if test="string($value)"><gl-cor:taxPercentageRate contextRef="now"><xsl:value-of select="$value"/></gl-cor:taxPercentageRate></xsl:if>
<!--BT-142--><xsl:variable name="value" select="./cac:Item/ClassifiedTaxCategory/cbc:ID"/><xsl:if test="string($value)"><gl-cor:taxCode contextRef="now"><xsl:value-of select="$value"/></gl-cor:taxCode></xsl:if>
<!--BT-144--><xsl:variable name="value" select="./cac:Item/ClassifiedTaxCategory/cbc:TaxExemptionReason"/><xsl:if test="string($value)"><gl-cor:taxCommentExemption contextRef="now"><xsl:value-of select="$value"/></gl-cor:taxCommentExemption></xsl:if>
</gl-cor:taxes>
...
<!--BT-14--><xsl:variable name="value" select="//Invoice/cac:DespatchDocumentReference/cbc:ID"/><xsl:if test="string($value)"><gl-taf:originatingDocumentNumber contextRef="now"><xsl:value-of select="$value"/></gl-taf:originatingDocumentNumber></xsl:if>
</gl-taf:originatingDocumentStructure>
<gl-taf:originatingDocumentStructure>
<gl-taf:originatingDocumentType contextRef="now">receive-advice</gl-taf:originatingDocumentType>
<!--BT-13--><xsl:variable name="value" select="//Invoice/cac:ReceiptDocumentReference/cbc:ID"/><xsl:if test="string($value)"><gl-taf:originatingDocumentNumber contextRef="now"><xsl:value-of select="$value"/></gl-taf:originatingDocumentNumber></xsl:if>
</gl-taf:originatingDocumentStructure>
...
<xsl:variable name="value" select="//CreditNote/cac:PaymentMeans/cbc:PaymentID"/><xsl:if test="string($value)">
<gl-taf:originatingDocumentStructure>
